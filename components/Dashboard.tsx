    ...
    <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 lg:gap-8">
        ...
        <div className="bg-white border border-slate-200 p-4 lg:p-5 rounded-[24px] lg:rounded-[28px] flex flex-col sm:flex-row items-center justify-between gap-4 lg:gap-6 shadow-sm">
          <div className="flex items-center gap-3 lg:gap-4 w-full sm:w-auto">
            ...
            <div
              ...
              className={`w-10 h-10 lg:w-12 lg:h-12 rounded-xl lg:rounded-2xl flex items-center justify-center transition-all duration-500 flex-shrink-0 animate-in zoom-in-90 fade-in duration-300 ${dayStatus === 'elevated' || missedMeds.length > 0
            ...
            <div>
              ...
              <h3
                ...
                className={`text-sm lg:text-lg font-bold uppercase tracking-tight truncate animate-in slide-in-from-left-2 fade-in duration-500 ${missedMeds.length > 0 ? 'text-rose-600' : dayStatus === 'elevated' ? 'text-amber-600' : 'text-slate-800'
                  }`}
              >
                {currentStatusLabel}
              </h3>
          ...
          <div className="flex bg-slate-100 p-1 lg:p-1.5 rounded-xl lg:rounded-2xl border border-slate-200 w-full sm:w-auto">
            <button
              ...
              className={`flex-1 sm:flex-none px-4 lg:px-8 py-2.5 lg:py-3 rounded-lg lg:rounded-xl text-[9px] lg:text-xs font-black mono tracking-[0.1em] transition-all duration-300 flex items-center justify-center gap-2 lg:gap-3 ${dayStatus === 'stable'
            ...
            <button
              ...
              className={`flex-1 sm:flex-none px-4 lg:px-8 py-2.5 lg:py-3 rounded-lg lg:rounded-xl text-[9px] lg:text-xs font-black mono tracking-[0.1em] transition-all duration-300 flex items-center justify-center gap-2 lg:gap-3 ${dayStatus === 'elevated'
      ...
      <div className="xl:col-span-8 space-y-4 lg:space-y-8">
        <div className="bg-white p-6 lg:p-10 rounded-[32px] lg:rounded-[40px] border border-slate-200 shadow-sm relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 mb-8 lg:mb-12">
            {tasks.slice(0, 4).map(task => (
              <div key={task.id} className={`p-4 lg:p-6 rounded-2xl lg:rounded-3xl border transition-all duration-300 flex items-center gap-3 lg:gap-5 ${task.isCompleted ? 'bg-emerald-50/50 border-emerald-100' : 'bg-slate-50 border-slate-100'
                }`}>
                <div className={`w-9 h-9 lg:w-11 lg:h-11 rounded-lg lg:rounded-xl flex-shrink-0 flex items-center justify-center transition-all ${task.isCompleted ? 'bg-emerald-500 text-white' : 'bg-white text-slate-400 border border-slate-100'
                  }`}>
        ...
        <div className="bg-white p-6 lg:p-10 rounded-[32px] lg:rounded-[40px] border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="h-48 sm:h-64 lg:h-96 -mx-4 w-full">
